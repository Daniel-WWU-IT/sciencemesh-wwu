...
cp config/blackbox-exporter.yaml config/blackbox-exporter.merged.yaml

sed -i -e 's/^/  /' config/blackbox-exporter.merged.yaml
sed -i -e '/MODULES/r config/blackbox-exporter.merged.yaml' charts/blackbox-exporter.merged.yaml

helm install blackbox-exporter prometheus-community/prometheus-blackbox-exporter \
    -f charts/blackbox-exporter.merged.yaml

rm -f charts/blackbox-exporter.merged.yaml
rm -f config/blackbox-exporter.merged.yaml
